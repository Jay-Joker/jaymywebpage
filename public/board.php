...
<head>
    ...
    <style>
        ...
        td:nth-child(1){ width: 110px;text-align: center;}
        td:nth-child(2){ width: 650px;}
        td:nth-child(3){ width: 120px;text-align: center;}
        td:nth-child(4){ width: 110px;text-align: center;}
...
<div style="margin-left: auto; margin-right: auto; width: 1060px; margin-top: 100px; ">
...
<div style="width: 1060px; margin-right: auto; margin-left: auto; margin-top: 30px;">
...
<form action="board.php" method="get">
    <div class="search-board" style="width: 300px;
    padding-top: 40px;
    padding-left: 100px;
    margin-right: auto;
    margin-left: auto;">
